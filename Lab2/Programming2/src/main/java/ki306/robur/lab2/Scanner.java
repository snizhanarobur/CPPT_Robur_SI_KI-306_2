...
public class Scanner {
    ...
    /**
     * Метод для початку сканування документа.
    ...
    public void startScan(String documentName) throws IOException {
        ...
        System.out.printf("Початок сканування документа: %s\n", documentName);
    }

    /**
     * Метод для завершення сканування.
    ...
    public void finishScan() throws IOException {
        if (isScanning) {
            ...
            System.out.printf("Завершення сканування: %s\n", currentDocument);
